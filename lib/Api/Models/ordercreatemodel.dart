...
class Billing {
  ...
  Billing.fromJson(Map<String, dynamic> json) {
    ...
    country = json['country'] ?? shippingCountry;
    email = json['email'];
    phone = json['phone'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['country'] = country ?? shippingCountry;
    data['email'] = email;
    data['phone'] = phone;
    return data;
  }
...
class LineItems {
  ...
  LineItems(
      {this.productId, this.quantity, this.variationId, this.addedToCartTime});

  LineItems.fromJson(Map<String, dynamic> json) {
    productId = json['product_id'];
    quantity = json['quantity'];
    variationId = json['variation_id'];
    addedToCartTime = json['added_to_cart_time'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['added_to_cart_time'] = addedToCartTime;
    return data;
  }
}
